# 1 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
# 2 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 2
# 3 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 2
# 4 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 2
# 5 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 2

const unsigned char charS [] 
# 6 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 6 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0x4C, 0x92, 0x92, 0x92, 0x64, 0x00, 0x00, 0x00,
};

const unsigned char charT [] 
# 10 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 10 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0x06, 0x02, 0xFE, 0x02, 0x06, 0x00, 0x00, 0x00,
};

const unsigned char charA [] 
# 14 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 14 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0xF8, 0x24, 0x22, 0x24, 0xF8, 0x00, 0x00, 0x00,
};

const unsigned char charR [] 
# 18 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 18 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0xFE, 0x12, 0x32, 0x52, 0x8C, 0x00, 0x00, 0x00,
};

const unsigned char charH [] 
# 22 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 22 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0xFE, 0x10, 0x10, 0x10, 0xFE, 0x00, 0x00, 0x00,
};

const unsigned char charL [] 
# 26 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 26 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0xFE, 0x80, 0x80, 0x80, 0x80, 0x00, 0x00, 0x00,
};

const unsigned char charE [] 
# 30 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 30 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0xFE, 0x92, 0x92, 0x92, 0x82, 0x00, 0x00, 0x00,
};

const unsigned char charN [] 
# 34 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 34 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0xFE, 0x08, 0x10, 0x20, 0xFE, 0x00, 0x00, 0x00,
};

const unsigned char charO [] 
# 38 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 38 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0x7C, 0x82, 0x82, 0x82, 0x7C, 0x00, 0x00, 0x00,
};

const unsigned char charM [] 
# 42 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 42 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0xFE, 0x04, 0x18, 0x04, 0xFE, 0x00, 0x00, 0x00,
};

const unsigned char charD [] 
# 46 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                            __attribute__((__progmem__)) 
# 46 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                    = {
0xFE, 0x82, 0x82, 0x82, 0x7C, 0x00, 0x00, 0x00,
};

const unsigned char exclamationMark [] 
# 50 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                      __attribute__((__progmem__)) 
# 50 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                              = {
0xBE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

const unsigned char arrowSign [] 
# 54 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                __attribute__((__progmem__)) 
# 54 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                        = {
0x20, 0x20, 0xF8, 0x70, 0x20, 0x00, 0x00, 0x00,
};

const unsigned char rocketLogo [] 
# 58 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                 __attribute__((__progmem__)) 
# 58 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                         = {
...
const unsigned char spaceIcon [] 
# 69 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                __attribute__((__progmem__)) 
# 69 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                        = {
...
# 76 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
const unsigned char spaceTrashIcon [] 
# 76 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                     __attribute__((__progmem__))
# 76 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                            = {
...
const unsigned char damagedMeteorIcon [] 
# 81 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                        __attribute__((__progmem__)) 
# 81 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                                = {
...
# 88 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
/*const unsigned char meteorIcon [] PROGMEM = {

0x01, 0x0A, 0x1C, 0x3E, 0x7F, 0x3E, 0x1C, 0x08, 

};*/
# 91 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
/*const unsigned char meteorIcon [] PROGMEM = {

0x10, 0x38, 0x7C, 0xFF, 0xFF, 0x7C, 0x38, 0x10, 

};*/
# 94 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
const unsigned char meteorIcon [] 
# 94 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                 __attribute__((__progmem__))
# 94 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                        = {
...
# 107 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
const unsigned char extraHealthIcon [] 
# 107 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                      __attribute__((__progmem__)) 
# 107 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                              = {
...
# 115 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
const unsigned char extraBulletIcon [] 
# 115 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                      __attribute__((__progmem__)) 
# 115 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                              = {
...
# 124 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
const unsigned char shieldIcon [] 
# 124 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                 __attribute__((__progmem__)) 
# 124 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                         = {
...
# 131 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
/*const unsigned char rocketIcon [] PROGMEM = {

0x38, 0x30, 0xF8, 0x7E, 0x7E, 0xF8, 0x30, 0x38, 

};*/
# 135 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
const unsigned char rocketIcon [] 
# 135 "E:\\QII\\Arduino\\Sketch\\Sketch.ino" 3
                                 __attribute__((__progmem__))
# 135 "E:\\QII\\Arduino\\Sketch\\Sketch.ino"
                                        = {
...
void setup()
{
  ...
  oledScreen.begin(0x02 /*|< Gen. display voltage from 3.3V*/, 0x3C);
  ...
  for (int i = 0; i < 3; i++)
  {
    pinMode(healthLedPins[i], 0x1);
    pinMode(bulletLedPins[i], 0x1);
    for (int j = 0; j < 7; j++)
    {
      pinMode(scoreDisplayPins[i][j], 0x1);
    }
  }
  pinMode(buzzerPin, 0x1);


  pinMode(shootButtonPin, 0x0);
  attachInterrupt(((shootButtonPin) == 2 ? 0 : ((shootButtonPin) == 3 ? 1 : ((shootButtonPin) >= 18 && (shootButtonPin) <= 21 ? 23 - (shootButtonPin) : -1))), Shoot, 2);
  pinMode(upButtonPin, 0x0);
  attachInterrupt(((upButtonPin) == 2 ? 0 : ((upButtonPin) == 3 ? 1 : ((upButtonPin) >= 18 && (upButtonPin) <= 21 ? 23 - (upButtonPin) : -1))), UpButtonPressed, 2);
  pinMode(okButtonPin, 0x0);
  attachInterrupt(((okButtonPin) == 2 ? 0 : ((okButtonPin) == 3 ? 1 : ((okButtonPin) >= 18 && (okButtonPin) <= 21 ? 23 - (okButtonPin) : -1))), OkButtonPressed, 2);
  pinMode(downButtonPin, 0x0);
  attachInterrupt(((downButtonPin) == 2 ? 0 : ((downButtonPin) == 3 ? 1 : ((downButtonPin) >= 18 && (downButtonPin) <= 21 ? 23 - (downButtonPin) : -1))), DownButtonPressed, 2);
  pinMode(playerPotPin, 0x0);
  pinMode(ldrPin, 0x0);
}
...
void RedrawGame()
{
  ...
  if (!isDarkMode)
  {
    oledScreen.fillRect(0, 0, 128, 64, 1 /*|< Draw 'on' pixels*/ /*|< Draw 'on' pixels*/);
  }
  for (int i = 0; i < 16; i++)
  {
    for (int j = 0; j < 8; j++)
...
void InitializeGame()
{
  ...
  for (int i = 0; i < 3; i++)
  {
    digitalWrite(healthLedPins[i], 0x1);
    digitalWrite(bulletLedPins[i], 0x1);
  }
...
void IncreaseHealth()
{
  if (health < 3)
  {
    digitalWrite(healthLedPins[health], 0x1);
    health++;
  }
}
...
void DecreaseHealth()
{
  ...
  health--;
  digitalWrite(healthLedPins[health], 0x0);
...
void IncreaseBullet()
{
  if (bullet < 3)
  {
    digitalWrite(bulletLedPins[bullet], 0x1);
    bullet++;
  }
}
...
void Shoot()
{
  ...
  {
    bullet--;
    digitalWrite(bulletLedPins[bullet], 0x0);
...
void GameOver()
{
  ...
  for (int i = 0; i < 3; i++)
  {
    digitalWrite(healthLedPins[i], 0x0);
    digitalWrite(bulletLedPins[i], 0x0);
  }
  delay(100);
  for (int i = 0; i < 3; i++)
  {
...
{
  for (int i = 0; i < 7; i++)
    digitalWrite(scoreDisplayPins[displayIndex][i], 0x0);

  switch (digit)
  {
    case 0:
      digitalWrite(scoreDisplayPins[displayIndex][0], 0x1);
      digitalWrite(scoreDisplayPins[displayIndex][1], 0x1);
      digitalWrite(scoreDisplayPins[displayIndex][2], 0x1);
      digitalWrite(scoreDisplayPins[displayIndex][3], 0x1);
      digitalWrite(scoreDisplayPins[displayIndex][4], 0x1);
      digitalWrite(scoreDisplayPins[displayIndex][5], 0x1);
      break;
    case 1:
      digitalWrite(scoreDisplayPins[displayIndex][1], 0x1);
      digitalWrite(scoreDisplayPins[displayIndex][2], 0x1);
    ...
    case 2:
      ...
      digitalWrite(scoreDisplayPins[displayIndex][3], 0x1);
      digitalWrite(scoreDisplayPins[displayIndex][4], 0x1);
      digitalWrite(scoreDisplayPins[displayIndex][6], 0x1);
      break;
    case 3:
      digitalWrite(scoreDisplayPins[displayIndex][0], 0x1);
      digitalWrite(scoreDisplayPins[displayIndex][1], 0x1);
